        ...
        <section className="pt-8 md:pt-10">
            <div className="container-main">
                <div className="hero-shell">
                    <div className="grid min-h-[520px] items-stretch md:grid-cols-[1.05fr_0.95fr]">
                        <div className="flex items-center bg-[linear-gradient(135deg,#12345b,#0d2747)] px-8 py-14 text-white md:px-12">
                            <div className="max-w-xl">
                                ...
                                >
                                    Reliable security services and practical training for real-world needs
                                </motion.h1>
                                ...
                                >
                                    Professional guarding, visible site protection, access control,
                                    monitoring support, and structured training for individuals and organisations.
                                </motion.p>
